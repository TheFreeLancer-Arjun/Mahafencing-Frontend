...
import { useOurInspirations } from '../../../hook/useOurInspirations';

export default function OurInspirationsshow() {
  const {
    inspirations,
    loading,
    error,
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (editId) {
      await updateInspiration(editId, formData);
    } else {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-center mb-6">Our Inspirations</h1>
