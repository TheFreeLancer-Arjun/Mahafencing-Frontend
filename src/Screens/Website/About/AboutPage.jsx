          ...
          <div className="rounded-lg leading-relaxed  w-full">
            <div className="anime w-full p-5">
              <div className="anime text-black mt-3 lg:mt-7 text-sm lg:text-xl">
                ...
                Shri Chhatrapati Shivaji Maharaj established Swaraj (Own Kingdom) in the country using his sword and wrote the glorious history of the Marathas in golden words. But in the meantime European countries gave the appearance of a sword fighting skill. Sword fighting game is known as fencing in worldwide.Shri Chhatrapati Shivaji Maharaj established Swaraj (Own Kingdom) in the country using his sword and wrote the glorious history of the Marathas in golden words. But in the meantime European countries gave the appearance of a sword fighting skill. Sword fighting game is known as fencing in worldwide.
                </p>
                <p className="mb-4 font-bold">
